...
class CardTwo extends Page {
  constructor() {
    super(
      new Div(`//*[@id="app"]//div[@class="avatar-and-interests__form"]`),
      "Card 1"
    );
  }
  ...
  get unselectAll() {
    return new Label(
      `//*[@id="app"]//label[@for="interest_unselectall"]//span[@class="checkbox__box"]`,
      "Unselect all label"
    );
  }
  ...
  get checkboxes() {
    ...
    const labels = rawElements.map((el, i) => {
      return new Label(
        `//*[@id="app"]//div[@class="avatar-and-interests__interests-list"]/div[${
          i + 1
  ...
  get errofNotification() {
    return new Label(
      `//*[@id="app"]//li[@class="avatar-and-interests__error"]`,
      "Error notification"
    );
  }
  ...
  async getNotificationColor() {
    return this.errofNotification.getStyle("color");
  }
}
